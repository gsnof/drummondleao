...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Drummond Leão Odontologia | Clínica Odontológica em Belo Horizonte" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Drummond Leão Odontologia" },
      { name: "theme-color", content: "#0b2745" },
      { property: "og:site_name", content: "Drummond Leão Odontologia" },
